...
| `storageAccountSku` | string | `'Standard_GRS'` | `Premium_ZRS, Standard_GZRS, Standard_RAGRS, Standard_RAGZRS, Standard_ZRS]` | Storage Account Sku Name. |
...
| `privateEndpointIntegration` | bool | `True` |  | is Private Endpoint enabled ?. |
